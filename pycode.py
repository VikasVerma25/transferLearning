...
train_data_dir = 'data1a/training/'
validation_data_dir = 'data1a/validation/'
...
checkpoint = ModelCheckpoint("recognise.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only = True,
                             verbose=1)
...
nb_train_samples = 1886
nb_validation_samples = 788
...
classifier = load_model('recognise.h5')
...
for i in range(0,2):
    input_im = getRandomImage("data1a/test/")
